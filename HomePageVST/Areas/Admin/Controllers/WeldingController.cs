...
namespace HomePageVST.Areas.Admin.Controllers
{
    ...
    public class WeldingController : ControllerCore
    {
        ...
        public WeldingController(IDocumentService documentService)
        {
            ...
            ViewBag.Active = "welding";
        }

        public ActionResult Index()
        {
            var docs = _documentService.GetListDocumentByCategoryId(CommonConstants.WELDING_CATEGORY_ID);
            return View(docs);
        }
        ...
        public ActionResult Create(DocumentViewModels document)
        {
            ...
            document.CategoryId = CommonConstants.WELDING_CATEGORY_ID;
